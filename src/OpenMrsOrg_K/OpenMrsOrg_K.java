...
//        Assert.assertTrue(ID.isDisplayed());
    ...
    public void HastaAramaP() throws AWTException {
        ...
        hastaAra.sendKeys("100P5V");//hasta sonradan silinmiş olabilir
        MyFunc.Bekle(3);
        Assert.assertTrue(acilanListe.getText().contains("100P5V"),"Aranan hasta ID bulunamadı");
